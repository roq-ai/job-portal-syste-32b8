...
function JobViewPage() {
  ...
  const queryParams = useMemo<{ include: { recruiter: boolean } }>(
    () =>
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Job Type" text={data?.job_type} />

                <FormListItem
                  label="Posted Date"
                  text={data?.posted_date ? format(data?.posted_date, 'dd-MM-yyyy') : ''}
                />
