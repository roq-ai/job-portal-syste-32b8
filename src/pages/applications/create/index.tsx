...
function ApplicationCreatePage() {
  ...
  const formik = useFormik<ApplicationInterface>({
    initialValues: {
      ...
      resume: '',
      cover_letter: '',
      job_seeker_id: (router.query.job_seeker_id as string) ?? null,
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<JobSeekerInterface>
            formik={formik}
            name={'job_seeker_id'}
            label={'Select Job Seeker'}
            placeholder={'Select Job Seeker'}
            fetcher={() => roqClient.job_seeker.findManyWithCount({})}
            labelField={'resume'}
          />
