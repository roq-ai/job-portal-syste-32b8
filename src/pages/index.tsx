...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Job Portal System App`}</title>

        <meta
          name="description"
          content="Welcome to Job Portal System App - Your dedicated platform uniting recruiters and job seekers in the digital world. Streamlining job search and recruitment like never before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxqb2IlMjBwb3J0YWx8ZW58MHx8fHwxNjk3NzEwNjg4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Job Portal System App`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Job Portal System App - Your dedicated platform uniting recruiters and job seekers in the digital world. Streamlining job search and recruitment like never before.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Job Seeker" type="job-seeker" abilities={appConfig.ownerAbilities} />
