...
import { useRecruiterFindFirst, useRoqClient } from 'lib/roq';
...
function RecruiterViewPage() {
  ...
  const { data, error, isLoading } = useRecruiterFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('recruiter', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/recruiters/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Job Posted" text={data?.job_posted} />

                <FormListItem label="Job Filled" text={data?.job_filled} />

                <FormListItem label="Active Jobs" text={data?.active_jobs} />

                <FormListItem label="Inactive Jobs" text={data?.inactive_jobs} />
